...
const ServiceDetail = () => {
  return (
    <div className="h-screen bg-gray-50 text-gray-900">
      <div className="grid grid-cols-1 md:grid-cols-5 max-w-7xl mx-auto h-full mt-16 md:mt-0">
        <div className="hidden md:block md:col-span-2 border-r bg-white h-full">
          <div className="sticky top-0 h-full p-6">
            ...
            <div className="rounded-2xl border bg-white shadow-md p-6 w-full">
              <div className="flex items-baseline justify-between mb-4">
                <div>
                  <span className="text-lg font-bold">Từ ₫30.563.677</span>
                  <span className="text-sm text-gray-500"> /khách</span>
                </div>
                <span className="text-sm text-pink-500">Hủy miễn phí</span>
              </div>
        ...
        <div className="md:col-span-3 overflow-y-auto p-6">
            ...
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="flex flex-col space-y-6 md:w-1/2">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <p className="text-lg font-semibold">Học vấn và đào tạo</p>
                    <p className="text-gray-600 text-sm leading-relaxed">
          ...
          <div>
            ...
            <div className="grid grid-rows-2 grid-cols-2 gap-2 rounded-3xl overflow-hidden md:h-[500px] h-[300px] border-b border-gray-200 pb-8">
